...
- [x] **Step 1: Write failing transport and response tests**
...
- [x] **Step 3: Implement the minimal fixed-host client**
...
- [x] **Step 4: Run focused and secret-store tests**
...
- [x] **Step 3: Implement bounded deterministic rendering**
...
- [x] **Step 4: Run formatter and privacy tests**
...
- [x] **Step 2: Write failing rate-limit and fault tests**
...
- [x] **Step 4: Implement the minimal worker**
...
- [x] **Step 5: Run focused, provider and store tests**
...
- [x] **Step 1: Write failing CLI/systemd/status tests**
...
- [x] **Step 3: Implement CLI and unit integration**
...
- [x] **Step 4: Run CLI/systemd/status and architecture tests**
...
## Verified implementation evidence through Task 4
